...
import { resetBrandAsset, uploadBrandAsset, type BrandActionState } from "@/app/admin/actions";
...
function BrandAssetCard({ kind, asset }: { kind: BrandAssetKind; asset?: BrandAsset }) {
